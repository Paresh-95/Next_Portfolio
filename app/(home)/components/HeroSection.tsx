...
function HeroSection() {
  return (
    <div className=" min-h-[60vh] flex gap-16 flex-col-reverse lg:gap-0 lg:flex-row items-center justify-between">
      <div className="space-y-10 text-center lg:text-left">
        ...
        <p className="md:w-96 text-lg text-gray-300">
          Based in India I'm a FullStack Devloper passionate about building a
          modern web application that user love
        </p>
        <Link
